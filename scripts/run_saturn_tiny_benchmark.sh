...
IN_DATA="${IN_DATA:-data/saturn_run_tiny.csv}"
WORK_DIR="${WORK_DIR:-out/saturn_tiny_benchmark/}"
CENTROIDS_INIT_PATH="${CENTROIDS_INIT_PATH:-out/saturn_tiny_benchmark_centroids_seed${SEED}.pkl}"
...
PRETRAIN_MODEL_PATH="${PRETRAIN_MODEL_PATH:-out/saturn_tiny_benchmark_pretrain_seed${SEED}.pt}"
METRIC_MODEL_PATH="${METRIC_MODEL_PATH:-out/saturn_tiny_benchmark_metric_seed${SEED}.pt}"
